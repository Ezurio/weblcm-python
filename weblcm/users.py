...
class UserManageHelper(object):
    ...
    def verify(cls, username, password):
        ...
        return attempt == WeblcmConfigManage.get_key_from_section(
    ...
    def updatePermission(cls, username, permission):
        if permission and WeblcmConfigManage.get_key_from_section(
            username, "permission", None
        ):
            return WeblcmConfigManage.update_key_from_section(
                username, "permission", permission
            )
        return False
...
class UserManage(object):
    ...
    def GET(self, *args, **kwargs):
        result = {
            ...
            "Default_user": cherrypy.request.app.config["weblcm"].get(
                "default_username", "root"
            ),
        }
