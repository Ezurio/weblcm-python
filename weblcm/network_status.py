...
class NetworkStatusHelper(object):
    ...
    def get_dev_status(cls, dev):
        ...
        try:
            status['DeviceTypeText'] = definition.WEBLCM_DEVTYPE_TEXT.get(dev.DeviceType)
        except:
    ...
    with NetworkStatusHelper._lock:
        if new_state == NetworkManager.NM_DEVICE_STATE_ACTIVATED:
            ...
            if dev.DeviceType == NetworkManager.NM_DEVICE_TYPE_WIFI:
                ...
                NetworkStatusHelper._network_status[dev.Interface]['activeaccesspoint'] = NetworkStatusHelper.get_ap_properties(
