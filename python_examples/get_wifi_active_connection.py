...
active_connection_id = active_connection_prop_iface.Get(NM_CONNECTION_ACTIVE_IFACE, "Id")
active_connection_uuid = active_connection_prop_iface.Get(NM_CONNECTION_ACTIVE_IFACE, "Uuid")
active_connection_type = active_connection_prop_iface.Get(NM_CONNECTION_ACTIVE_IFACE, "Type")
active_connection_state = active_connection_prop_iface.Get(NM_CONNECTION_ACTIVE_IFACE, "State")
